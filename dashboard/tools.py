...
from python_tools.get_temperatures import reachy_temperature
...
def update_git():
    local_repo = Repo('/Users/simon/dev/reachy')
    ...
    if not latest_online_tag == latest_local_tag:
        cmd.Git('/Users/simon/dev/reachy').pull()
